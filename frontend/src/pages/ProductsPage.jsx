    ...
    useEffect(() => {
        ...
        if (categoryData) {
            filteredData = filteredData.filter(
                (product) => product.category.trim().toLowerCase() === categoryData.trim().toLowerCase(),
            );
        }
        ...
        <>
            {isLoading ? (
                ...
                <div>
                    ...
                    <div className={`${styles.section} flex flex-col lg:flex-row gap-6 mt-10 mb-20`}>
                        {/* DropDown Section */}
                        ...
                        <div className="flex-1">
                            ...
                            {data && data.length === 0 && (
                                <div className="flex flex-col items-center mt-10">
                                    ...
                                    <h5 className="text-center mt-4 text-lg text-gray-600">No products found</h5>
                                </div>
                            )}
                        </div>
                    </div>
