const styles = {
    ...
    heading: 'text-[27px] text-center md:text-start font-[600] font-Rubik pb-[20px]',
    section: 'w-11/12 mx-auto',
    productTitle: 'text-[25px] font-[600] font-Rubik text-[#333]',
    productTitleEvent: 'text-[40px] font-[700] font-Rubik text-[#333]',
    productDiscountPrice: 'font-bold text-[19px] text-[#333] font-Rubik',
    ...
    button: 'w-[150px] bg-[#131921] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer ',
