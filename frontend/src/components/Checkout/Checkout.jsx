...
const Checkout = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.get(`${server}/coupon/get-coupon-value/${name}`).then((res) => {
            ...
            if (res.data.couponCode === null) {
                toast.error('This voucher code does not exist!');
                setCouponCode('');
            }
        });
    };
        ...
        <div className="w-full 800px:w-[95%] bg-white rounded-md p-5 pb-8">
            ...
            <form>
                <div className="w-full flex pb-3">
                    <div className="w-[50%]">
                        <label className="block pb-2">Customer Name:</label>
            ...
            />
                    ...
                    <div className="w-[50%]">
                        <label className="block pb-2">Province/City:</label>
                        <select
           ...
           <label className="block pb-2">Tỉnh, thành phố:</label>
            ...
            <h5 className="text-[18px] cursor-pointer inline-block" onClick={() => setUserInfo(!userInfo)}>
                Choose your saved address: <h5 className="text-[#027df0fd]">(Click here to select)</h5>
            </h5>
            {userInfo && (
                <div>
                    {user &&
    ...
    return (
        <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
            <div className="flex justify-between">
                <h3 className="text-[16px] font-[400] text-[#000000a4]">Total Amount:</h3>
                <h5 className="text-[18px] font-[600]">{currency.format(subTotalPrice, { code: 'VND' })}</h5>
            </div>
            <br />
            <div className="flex justify-between">
                <h3 className="text-[16px] font-[400] text-[#000000a4]">Shipping Fee:</h3>
            ...
            <form onSubmit={handleSubmit}>
                <input
                    ...
                    placeholder="Apply Voucher Code Now!!!"
                    value={couponCode}
