            ...
            {isLoading ? (
                ...
                <div className="w-full mx-8 pt-1 mt-10 bg-white">
                    <div className="w-full flex justify-end">
                        ...
                        >
                            <span className="text-white">Add Coupon Code</span>
                        </div>
                    </div>
                    ...
                    {open && (
                        <div className="fixed top-0 left-0 w-full h-screen bg-[#00000062] z-[20000] flex items-center justify-center">
                            <div className="w-[90%] 800px:w-[40%] h-[80vh] bg-white rounded-md shadow p-4">
                                ...
                                <h5 className="text-[30px] font-Poppins text-center">Add Coupon Code</h5>
                                <form onSubmit={handleSubmit} aria-required={true}>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="Enter discount percentage (% < 100%)..."
                                        />
                                    </div>
                                    <br />
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="Enter minimum amount for discount..."
                                        />
                                    </div>
                                    <br />
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder="Enter maximum amount for discount..."
                                        />
                                    </div>
                                    <br />
                                    <div>
                                        <label className="pb-2">Select Products for Discount</label>
                                        <select
                                            className="w-full mt-2 border h-[35px] rounded-[5px]"
                                            value={selectedProducts}
                                            onChange={(e) => setSelectedProducts(e.target.value)}
                                        >
                                            <option value="Choose your selected products">Select Products</option>
                                            {products &&
                                                products.map((i) => (
