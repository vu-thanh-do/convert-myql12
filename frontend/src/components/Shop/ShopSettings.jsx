                ...
                <form aria-aria-required={true} className="flex flex-col items-center" onSubmit={updateHandler}>
                    <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
                        <div className="w-full pl-[3%]">
                            <label className="block pb-2">Store Name</label>
                        </div>
                        <input
                            type="name"
                    ...
                    <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
                        ...
                        <input
                            type="name"
                            placeholder={`${
                                seller?.description ? seller.description : 'Add a description for your store...'
                            }`}
                            value={description}
                    ...
                    <div className="w-[100%] flex items-center flex-col 800px:w-[50%] mt-5">
                        <div className="w-full pl-[3%]">
                            <label className="block pb-2">Store Address</label>
                        </div>
                        <input
                            type="name"
