...
const WithdrawMoney = () => {
    ...
    const withdrawHandler = async () => {
        if (withdrawAmount < 50 || withdrawAmount > availableBalance) {
            ...
            await axios
                .post(`${server}/withdraw/create-withdraw-request`, { amount }, { withCredentials: true })
                .then((res) => {
        ...
        <div className="w-full h-[90vh] p-8">
            <div className="w-full bg-white h-full rounded flex items-center justify-center flex-col">
                <h5 className="text-[20px] pb-4">
                    <h4>Available Balance: {`${currency.format(availableBalance, { code: 'VND' })}`}</h4>
                </h5>
                <div
                    ...
                    />
                                    ...
                                    <div className="pt-2">
                                        ...
                                        <input
                                            ...
                                            required
                                            placeholder="Add a bank account number!"
                                            className={`${styles.input} mt-2`}
                                        />
                                    </div>
                                    <div className="pt-2">
                                        ...
                                        <input
                                            ...
                                            id=""
                                            placeholder="Add the bank account holder's name!"
                                            className={`${styles.input} mt-2`}
                                        />
                                    </div>
                                    ...
                                    <div className="pt-2">
                                        <label>
                                            Bank Registration Address <span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            type="text"
                                            name=""
                                            ...
                                            placeholder="Enter the bank branch registration address!"
                                            className={`${styles.input} mt-2`}
                                        />
                                    </div>
                            ...
                            <>
                                <h3 className="text-[22px] font-Poppins">Withdrawal Method:</h3>
                                ...
                                {seller && seller?.withdrawMethod ? (
                                    <div>
                                        ...
                                        <br />
                                        <h4>
                                            Available Balance:{`${currency.format(availableBalance, { code: 'VND' })}`}
                                        </h4>
                                        <br />
                                        <span>
                                            Enter Withdrawal Amount: (Minimum available balance must be {'>'} 200.000
                                            VND)
                                        </span>
                      ...
                      >
                        Rút tiền
                                    ...
                                    <div>
                                        <p className="text-[18px] pt-2">You have not updated a withdrawal method!</p>
