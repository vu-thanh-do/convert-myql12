                    ...
                    <div className="flex justify-center w-full">
                        <div className="relative">
                            <img
                                ...
                                className="w-[150px] h-[150px] rounded-full object-cover border-[3px] border-[#febd69]"
                                alt=""
                            />
                        ...
                        <form onSubmit={handleSubmit} aria-required={true}>
                            <div className="w-full 800px:flex block pb-3">
                                <div className=" w-[100%] 800px:w-[50%]">
                                    <label className="block pb-2">Full Name (Recipient's Name)</label>
                                    <input
                                        type="text"
                            ...
                            <div className="w-full 800px:flex block pb-3">
                                <div className=" w-[100%] 800px:w-[50%]">
                                    <label className="block pb-2">Phone Number: (+84)</label>
                                ...
                                <div className=" w-[100%] 800px:w-[50%]">
                                    <label className="block pb-2">Enter password to update information</label>
                                    <input
                                        type="password"
                                        className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
                                        required
                            ...
                            <input
                                className={`w-[250px] h-[40px] text-center text-[#febd69] font-bold rounded-[8px] mt-8 bg-[#232f3e] cursor-pointer transition duration-300 hover:bg-[#febd69] hover:text-[#232f3e]`}
                                required
                                value="Update"
                                type="submit"
                            />
        ...
        <div className="w-full px-5">
            ...
            <div className="w-full">
                <form aria-required onSubmit={passwordChangeHandler} className="flex flex-col items-center">
                    ...
                    <div className=" w-[100%] 800px:w-[50%] mt-2">
                        <label className="block pb-2">Re-enter New Password</label>
                        <input
                            type="password"
                            className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
                            required
                        ...
                        <div className="w-full">
                            <form aria-required onSubmit={handleSubmit} className="w-full">
                                <div className="w-full block p-4">
                                    ...
                                    <div className="w-full pb-2">
                                        <label className="block pb-2">City, Province:</label>
                                        <select
                                            name=""
                                            id=""
                                            value={city}
                                    ...
                                    <div className="w-full pb-2">
                                        <label className="block pb-2">
                                            Address Line 1 (Provide full details: house number, street name, ward,
                                            hamlet, district, commune, city)
                                        </label>
                                        <input
                                            type="address"
